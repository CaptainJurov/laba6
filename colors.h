...
namespace Colors {
    ...
    const char * ital = "\033[3m";
    const char * конец_ital = "\033[23m";
    const char * зачёрк = "\033[21m";
    const char * недозелёный = "\033[38;2;170;230;170m";
    const char * скучный = "\033[38;2;130;130;130m";
    const char * clear = "\033[99A\033[0J";
}
